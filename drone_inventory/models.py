...
class Drone(db.Model):
    ...
    description = db.Column(db.String(200)) #nullable defaults to True
    ...
    weigth = db.Column(db.String(100))
    cost_of_production = db.Column(db.Numeric(12, 2))
    series = db.Column(db.String(100))
    random_joke = db.Column(db.String)
    user_token = db.Column(db.String, db.ForeignKey('user.token'), nullable = False)


    def __init__(self, name, description, price, camera_quality, flight_time, max_speed, dimensions, weigth, cost_of_production, series, random_joke, user_token, id =''):
        self.id = self.set_id()
        self.name = name
